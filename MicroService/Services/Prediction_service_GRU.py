...
model = load_model('E:/Semester/Thesis/Software/Example-Applications-main/Real-Time Transmission/MicroService/GRU.keras')
...
consumer = KafkaConsumer(
    ...
    group_id='26', # Specify the consumer group ID
...
def save_to_influx(bucket_name, prediction,Infer_latency,request_latency,cpu_usage,memory_usage,read_bytes,write_bytes,throughtput):
    ...
    json_body = [
        {
            "measurement": "Prediction_result_GRU",
            "tags": {},
            "time": current_time,
            "fields": {
...
def consume_and_process():
    ...
    for message in consumer:
        ...
        if len(df_ary)>=30:
            ...
            save_to_influx("Microservice_GRU", result,Infer_latency,requect_latency,cpu_usage,memory_usage,read_bytes,write_bytes,throughtput)
